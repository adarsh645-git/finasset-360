...
- **Superseded in part by 25:** the keys are now the class id only (not class + Holding/Liability). Selecting a Holding/Liability row with the form open leaves the form and draft as they are — it belongs to the class, and 25's deselect-on-open would otherwise remount the form. Item 2 is therefore the "explicit note that it persists" branch.
