...
// The "add my own custom Asset Class" affordance (user story 7) at the
// bottom of the Asset Class column — a plain button that swaps for an
// inline name field rather than opening a separate dialog, matching this
// ticket's Miller-column-first navigation.
export function AddAssetClassRow({
  onAdd,
}: {
